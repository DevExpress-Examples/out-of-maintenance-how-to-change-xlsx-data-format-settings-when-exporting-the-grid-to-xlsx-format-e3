...
namespace DXSample.nwindDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Products` WHERE ((`ProductID` = ?) AND ((? = 1 AND `ProductName` IS NULL) OR (`ProductName` = ?)) AND ((? = 1 AND `UnitPrice` IS NULL) OR (`UnitPrice` = ?)) AND ((? = 1 AND `UnitsInStock` IS NULL) OR (`UnitsInStock` = ?)) AND ((? = 1 AND `Discontinued` IS NULL) OR (`Discontinued` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Products` (`ProductName`, `UnitPrice`, `UnitsInStock`, `Discontinued" +
                "`) VALUES (?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Products` SET `ProductName` = ?, `UnitPrice` = ?, `UnitsInStock` = ?, `Discontinued` = ? WHERE ((`ProductID` = ?) AND ((? = 1 AND `ProductName` IS NULL) OR (`ProductName` = ?)) AND ((? = 1 AND `UnitPrice` IS NULL) OR (`UnitPrice` = ?)) AND ((? = 1 AND `UnitsInStock` IS NULL) OR (`UnitsInStock` = ?)) AND ((? = 1 AND `Discontinued` IS NULL) OR (`Discontinued` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductID, ProductName, UnitPrice, UnitsInStock, Discontinued FROM Product" +
                "s";
        ...
        public virtual int Delete(int Original_ProductID, string Original_ProductName, global::System.Nullable<decimal> Original_UnitPrice, global::System.Nullable<short> Original_UnitsInStock, bool Original_Discontinued) {
            ...
            this.Adapter.DeleteCommand.Parameters[8].Value = ((bool)(Original_Discontinued));
        ...
        public virtual int Insert(string ProductName, global::System.Nullable<decimal> UnitPrice, global::System.Nullable<short> UnitsInStock, bool Discontinued) {
            if ((ProductName == null)) {
        ...
        public virtual int Update(string ProductName, global::System.Nullable<decimal> UnitPrice, global::System.Nullable<short> UnitsInStock, bool Discontinued, int Original_ProductID, string Original_ProductName, global::System.Nullable<decimal> Original_UnitPrice, global::System.Nullable<short> Original_UnitsInStock, bool Original_Discontinued) {
            if ((ProductName == null)) {
                throw new global::System.ArgumentNullException("ProductName");
            }
            else {
