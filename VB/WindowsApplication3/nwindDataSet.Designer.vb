	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class ProductsDataTable
			...
			Public Function AddProductsRow(ByVal ProductName As String, ByVal UnitPrice As Decimal, ByVal UnitsInStock As Short, ByVal Discontinued As Boolean) As ProductsRow
				...
				Dim columnValuesArray() As Object = { Nothing, ProductName, UnitPrice, UnitsInStock, Discontinued}
...
Namespace DXSample.nwindDataSetTableAdapters
	...
	Partial Public Class ProductsTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT ProductID, ProductName, UnitPrice, UnitsInStock, Discontinued FROM Product" & "s"
		...
		Public Overridable Function Delete(ByVal Original_ProductID As Integer, ByVal Original_ProductName As String, ByVal Original_UnitPrice? As Decimal, ByVal Original_UnitsInStock? As Short, ByVal Original_Discontinued As Boolean) As Integer
			...
			Me.Adapter.DeleteCommand.Parameters(8).Value = (CBool(Original_Discontinued))
		...
		Public Overridable Function Insert(ByVal ProductName As String, ByVal UnitPrice? As Decimal, ByVal UnitsInStock? As Short, ByVal Discontinued As Boolean) As Integer
			...
			End If
			Me.Adapter.InsertCommand.Parameters(3).Value = (CBool(Discontinued))
		...
		Public Overridable Function Update(ByVal ProductName As String, ByVal UnitPrice? As Decimal, ByVal UnitsInStock? As Short, ByVal Discontinued As Boolean, ByVal Original_ProductID As Integer, ByVal Original_ProductName As String, ByVal Original_UnitPrice? As Decimal, ByVal Original_UnitsInStock? As Short, ByVal Original_Discontinued As Boolean) As Integer
			If (ProductName Is Nothing) Then
				Throw New Global.System.ArgumentNullException("ProductName")
			Else
			...
			End If
			Me.Adapter.UpdateCommand.Parameters(3).Value = (CBool(Discontinued))
			...
			Me.Adapter.UpdateCommand.Parameters(12).Value = (CBool(Original_Discontinued))
